...
namespace test
{
    class Program
    {
        static short _version = 1;
        static WalletAccount _user;
...
//                StartLocalNode();
        ...
        static VoteTransaction CreateVoteTransaction()
        {
        ...
        static void PersistCompleted(object sender, Block block)
        {
        ...
        static void UpdateTurnTable(Block block)
        {
