...
namespace Mineral.Core.Database
{
    ...
    public partial class DatabaseManager
    {
        ...
        private AccountStateStoreTrie account_state_store_trie = null;
        ...
        public AccountStateStoreTrie AccountStateTrie => this.account_state_store_trie;
        ...
        public DatabaseManager()
        {
            ...
            this.block_store = new BlockStore(this.revoking_store, "block");
            this.block_index_store = new BlockIndexStore(this.revoking_store, "block-index");
            this.recent_block_store = new RecentBlockStore(this.revoking_store, "recent-block");
            this.transaction_store = new TransactionStore(this.revoking_store, this.block_store, this.khaos_database, "transaction");
            this.transaction_cache = new TransactionCache(this.revoking_store, "trans-cache");
            this.transaction_history_store = new TransactionHistoryStore(this.revoking_store, "transaction_history_store");
            this.account_store = new AccountStore(this.revoking_store, "account");
            this.account_index_store = new AccountIndexStore(this.revoking_store, "account-index");
            this.account_id_index_store = new AccountIdIndexStore(this.revoking_store, "accountid-index");
            this.account_state_store_trie = new AccountStateStoreTrie(this.revoking_store, "account-trie");
            this.witness_store = new WitnessStore(this.revoking_store, "witness");
            this.witness_schedule_store = new WitnessScheduleStore(this.revoking_store, "siwtness_schedule");
            this.votes_store = new VotesStore(this.revoking_store, "votes");
            this.proposal_store = new ProposalStore(this.revoking_store, "proposal");
            this.asset_issue_store = new AssetIssueStore(this.revoking_store, "asset-issue");
            this.asset_issue_v2_store = new AssetIssueV2Store(this.revoking_store, "asset-issue-v2");
            this.exchange_store = new ExchangeStore(this.revoking_store, "exchange");
            this.exchange_v2_store = new ExchangeV2Store(this.revoking_store, "exchange-v2");
            this.code_store = new CodeStore(this.revoking_store, "code");
            this.contract_store = new ContractStore(this.revoking_store, "contract");
            this.storage_row_store = new StorageRowStore(this.revoking_store, "storage-row");
            this.delegated_resource_store = new DelegatedResourceStore(this.revoking_store, "delegate-resource");
            this.delegate_resource_Account_index_store = new DelegatedResourceAccountIndexStore(this.revoking_store, "delegate-resource-account-index");
            this.dynamic_properties_store = new DynamicPropertiesStore(this.revoking_store, "properties");
                                          ...
                                          bool need_check_witness_permission)
        {
            ...
            using (Profiler.Measure("GenerateBlock Transaction Pending"))
            {
                ...
                Profiler.PushFrame("RePush transaction");
