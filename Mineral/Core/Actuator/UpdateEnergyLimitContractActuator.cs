...
{
    public class UpdateEnergyLimitContractActuator : AbstractActuator
    {
        #region Field
        #endregion
        ...
        public override bool Validate()
        {
            ...
            {
                throw new ContractValidateException(
                    "contract type error,expected type [UpdateSettingContract],real type[" + this.contract.GetType().Name + "]");
            }
