...
namespace Mineral.Old
{
    ...
    public class PrevConfig
    {
        ...
        private static PrevConfig instance = null;
        public static PrevConfig Instance { get { return instance = instance ?? new PrevConfig(); } }
        ...
        public bool Initialize(string path)
        {
            ...
            try
            {
                if (File.Exists(path))
                {
                    ...
                    {
                        instance = JsonConvert.DeserializeObject<PrevConfig>(file.ReadToEnd());
