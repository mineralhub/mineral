...
namespace Mineral.Cryptography.zksnark
{
    public class Parameters
    {
         ...
         */
        public static readonly BigInteger R = new BigInteger("21888242871839275222246405745257275088548364400416034343698204186575808495617");

        /**
         * "b" curve parameter for {@link BN128Fp}
         */
        public static readonly Fp B_Fp = Fp.Create(BigInteger.ValueOf(3));

        /**
         * Twist parameter for the curves
         */
        public static readonly Fp2 TWIST = Fp2.Create(BigInteger.ValueOf(9), BigInteger.ValueOf(1));

        /**
         * "b" curve parameter for {@link BN128Fp2}
         */
        public static readonly Fp2 B_Fp2 = B_Fp.Mul(TWIST.Inverse());

        public static readonly Fp2 TWIST_MUL_BY_P_X = Fp2.Create(
        ...
        public static readonly Fp2 TWIST_MUL_BY_P_Y = Fp2.Create(
        ...
        public static readonly BigInteger PAIRING_FINAL_EXPONENT_Z = new BigInteger("4965661367192848881");
    }
